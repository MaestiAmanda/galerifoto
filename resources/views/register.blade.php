...
<head>
    ...
    <title>Website Galeri Foto | Register</title>
...
<body class="bg-slate-400">
    <nav class="bg-white border-gray-200 shadow-md dark:bg-gray-900">
        <div class="flex flex-wrap items-center justify-between max-w-screen-md p-4 mx-auto">
            <h3 class="text-3xl font-pacifico text-">Galeri</h3>
        ...
        <div class="max-w-[364px] bg-white rounded-md shadow-md mx-auto px-6 py-4">
            <form action="/registered" method="post">
                ...
                <div class="flex flex-col">
                    <a href = "/" class="mx-auto text text-3xl font-hurricane">Register</a>
                    <div>
                    ...
                    <button type="submit" class="py-2 mt-4 text-white rounded-full bg-blue-700">Register</button>
                    &nbsp;
